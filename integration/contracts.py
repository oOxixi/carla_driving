...
class DetectedObject:
    """One RGB road-user detection, optionally fused with a LiDAR range."""
    ...
    def __post_init__(self) -> None:
        ...
        confidence = _finite_or_none("confidence", self.confidence)
        ...
        if any(value is None or value < 0.0 or value > 1.0 for value in box):
