# download_fallback：功能记录

上级模块：[模块说明](../modules/support-delivery.md) · 实现：[weights/download_fallback.sh](../../../weights/download_fallback.sh)
...
- 第 4 行：`root="${RELEASE_WEIGHTS_DIR:-$(cd "$script_dir/.." && pwd)/release_assets/weights}"`
...
来源 SHA256：`0454419203037bbbab8d9889c29b2dc6e085ba1a1f13c20c05dd3a4861796ea1`。
