...
上级模块：[模块说明](../modules/vehicle-perception.md) · 实现：[perception/fault_injection.sh](../../../perception/fault_injection.sh)
...
- 第 14 行：`python -m perception.fault_injection \`
- 第 15 行：`--input "${input_path}" \`
- 第 16 行：`--output "${output_path}" \`
- 第 17 行：`--fault "${fault_name}" \`
...
### `perception/fault_injection.sh`

来源 SHA256：`fce3d3606db7873dbf3d76d06f904900b270d608ea1e13f46d13e9820b0d1690`。
