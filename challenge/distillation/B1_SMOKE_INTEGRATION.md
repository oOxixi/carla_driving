...
- Teacher revision used by this historical Smoke: `NOT_RECORDED_BY_B1_SMOKE`
- Teacher artifact fingerprint used by this historical Smoke:
  `NOT_RECORDED_BY_B1_SMOKE`
...
as the current Teacher identity. This Smoke is also not retroactively assigned
the formal Teacher revision because that information was not captured when the
samples were collected.

Formal B1 collection is now pinned separately to public
`Qwen/Qwen3.5-2B@15852e8c16360a2fea060d615a32b45270f8a8fc`, with artifact
fingerprint
`4bbf183b7b7f1ab9fb9eb325f189f4449d65e9fe664cbfe4bcc58a33888657fa`.
Only newly collected records carrying that complete provenance may enter a
formal A3 run.
...
- Exact revision/fingerprint are intentionally unavailable for this legacy
  Smoke; the trainer permits that only with `--integration-smoke`.
