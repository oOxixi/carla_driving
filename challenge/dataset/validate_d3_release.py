"""Fail-closed validation for B1's detached-signed D3 Wave1 add-on.
...
D3_DATASET_VERSION = "b1_d3_wave1_addon_v1"
D3_COHORT_VERSION = "teacher_distill_v0.5_d3_expansion_wave1_v4"
POSITIVE_FILES = {"train": "train_addition.jsonl", "val": "val_addition.jsonl"}
TEACHER_MANIFEST = "challenge/teacher_pinned_manifest_v4.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate detached-signed B1 D3 add-on")
    parser.add_argument(
