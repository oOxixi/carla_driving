# teacher_pinned_manifest：功能记录

上级模块：[模块说明](../modules/challenge-data.md) · 实现：[challenge/teacher_pinned_manifest.json](../../../challenge/teacher_pinned_manifest.json)
...
- `verification`：对象，直接字段：models_api, text_inference, planner_adapter_health, main_regression, qwf01_functional, qwf02_functional, internal_teacher_latency_probe, qwr05_turn_completion。
...
- `teacher_tag`：'teacher-baseline-v3'。
- `previous_teacher_git_sha`：'29df49e70e908dd1a0ecfdf1d59168a0c128cbfc'。
...
来源 SHA256：`48a1de3ccaea3919ddccaa36f4feaecb84513ab93a152943a416d9f1386c838c`。
