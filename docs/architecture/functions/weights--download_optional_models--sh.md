# download_optional_models：功能记录

上级模块：[模块说明](../modules/support-delivery.md) · 实现：[weights/download_optional_models.sh](../../../weights/download_optional_models.sh)
...
- 第 4 行：`root="${RELEASE_WEIGHTS_DIR:-$(cd "$script_dir/.." && pwd)/release_assets/weights}/optional"`
- 第 6 行：`case "${1:-}" in`
...
来源 SHA256：`c09722611c6583259cb0a1fd19063cd7830c59ee02ac2e6e5a2faac6211243b7`。
