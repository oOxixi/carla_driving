...
- 依次触发以 45km/h 正常巡航、前方约 200m 右转并减速至 25km/h、出弯回正、向左变道、恢复 45km/h 巡航。
...
- 画面是阴天傍晚低光的城市次干道和十字路口；公交站、横穿行人、慢车和自行车分布在 0.5km、2.3km、4.8km 和 7.0km。
- 公交车与两名乘客构成首个交互，后续事件覆盖路线中段和末段，避免只验证起步后的固定 1.1km。
...
3. S1 所选道路确为同向至少3车道，且右转路口位置与“前方200米”语义相符。
