# requirements-whisper-gpu-windows：功能记录

上级模块：[模块说明](../modules/support-voice.md) · 实现：[voice_group/requirements-whisper-gpu-windows.txt](../../../voice_group/requirements-whisper-gpu-windows.txt)
...
requirements-whisper-gpu-windows
