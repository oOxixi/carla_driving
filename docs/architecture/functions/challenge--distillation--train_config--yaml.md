...
上级模块：[模块说明](../modules/challenge-training.md) · 实现：[challenge/distillation/train_config.yaml](../../../challenge/distillation/train_config.yaml)
...
- `identity_policy: frozen_manifest`
- `contract:`
- `max_steps: 4`
- `max_targets: 8`
- `dataset:`
