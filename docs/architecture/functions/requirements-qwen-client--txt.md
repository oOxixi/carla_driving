# requirements-qwen-client：功能记录

上级模块：[模块说明](../modules/support-delivery.md) · 实现：[requirements-qwen-client.txt](../../../requirements-qwen-client.txt)
