"""Run audio -> real ASR -> real Qwen-VL -> D safety -> final control.
...
def main() -> int:
    ...
    if any(not row.get("audio_ref") for row in rows):
    ...
    report = {
        ...
        "full_chain_scope": (
            ...
            "raw-CARLA-LiDAR summary -> real Qwen -> strict boundary -> "
            "deterministic D safety -> final control"
        ),
