# voice_to_carla_runbook：功能记录

上级模块：[模块说明](../modules/support-delivery.md) · 实现：[notebooks/voice_to_carla_runbook.ipynb](../../../notebooks/voice_to_carla_runbook.ipynb)
...
Notebook 包含 9 个单元；运行顺序、环境与代码见原文件。单元输出是历史执行结果，不应自动视为当前结果。
