# fetch_scenario_runner：功能记录

上级模块：[模块说明](../modules/support-tools.md) · 实现：[scripts/fetch_scenario_runner.ps1](../../../scripts/fetch_scenario_runner.ps1)
