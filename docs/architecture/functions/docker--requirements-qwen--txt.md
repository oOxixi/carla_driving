# requirements-qwen：功能记录

上级模块：[模块说明](../modules/support-delivery.md) · 实现：[docker/requirements-qwen.txt](../../../docker/requirements-qwen.txt)
...
- `vllm==0.26.1.dev0+g568afb3a1.d20260802.cu132`
- `transformers==5.14.1`
- `openai==2.52.0`
- `pillow==12.2.0`
