# requirements-cu132-build：功能记录

上级模块：[模块说明](../modules/support-delivery.md) · 实现：[docker/requirements-cu132-build.txt](../../../docker/requirements-cu132-build.txt)
