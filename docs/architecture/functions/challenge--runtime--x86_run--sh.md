...
上级模块：[模块说明](../modules/challenge-export.md) · 实现：[challenge/runtime/x86_run.sh](../../../challenge/runtime/x86_run.sh)
...
- 第 5 行：`ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"`
- 第 7 行：`cd "${ROOT_DIR}"`
- 第 11 行：`python challenge/runtime/student_x86.py \`
...
来源 SHA256：`605dedde12d10c2453588a52fff1c52f371cb380e2a2880b2c3f1e6ac0fd2e6a`。
