# run_official_scenes：功能记录

上级模块：[模块说明](../modules/support-tools.md) · 实现：[scripts/run_official_scenes.ps1](../../../scripts/run_official_scenes.ps1)
...
- 第 2 行：`param(`
- 第 33 行：`elseif (Get-Command 'python' -ErrorAction SilentlyContinue) {`
- 第 34 行：`$PythonExecutable = 'python'`
