# download_asr_fallback：功能记录

上级模块：[模块说明](../modules/support-delivery.md) · 实现：[weights/download_asr_fallback.sh](../../../weights/download_asr_fallback.sh)
...
- 第 3 行：`script_dir="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"`
- 第 4 行：`root="${RELEASE_WEIGHTS_DIR:-$(cd "$script_dir/.." && pwd)/release_assets/weights}/asr"`
...
来源 SHA256：`53ee2d891496e07eaf24782856e62143d17fc1d967ac3e89c4e99723c7f8f605`。
