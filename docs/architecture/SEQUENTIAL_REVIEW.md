...
| 13 | [蒸馏与晋级](modules/challenge-training.md) | **本轮完成**：25份实现/配置页、19页103处占位改写；A01已在后续代码轮关闭，真实B2证据仍缺 |
...
- 明确soft蒸馏只覆盖两个Head、mask/分母、max_updates=0、checkpoint与纯权重区别；当时登记的A01 Student评估身份缺口已于2026-09-22关闭。
