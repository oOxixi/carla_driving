# d2_v1_1_formal_config：功能记录

上级模块：[模块说明](../modules/challenge-training.md) · 实现：[challenge/distillation/d2_v1_1_formal_config.yaml](../../../challenge/distillation/d2_v1_1_formal_config.yaml)
...
- `identity_policy: signed_d2_release_formal`
- `contract:`
- `max_steps: 4`
- `max_targets: 8`
- `dataset:`
...
- `output:`
- `directory: artifacts/challenge/distillation/d2_v1_1_fp32_baseline_v1`
