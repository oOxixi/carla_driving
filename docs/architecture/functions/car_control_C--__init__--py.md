...
上级模块：[模块说明](../modules/vehicle-longitudinal.md) · 实现：[car_control_C/__init__.py](../../../car_control_C/__init__.py)
...
- [car_control_C/tests/test_safety_state.py](../../../car_control_C/tests/test_safety_state.py)
