# run_scenario_runner：功能记录

上级模块：[模块说明](../modules/support-tools.md) · 实现：[scripts/run_scenario_runner.ps1](../../../scripts/run_scenario_runner.ps1)
...
- 第 1 行：`param(`
- 第 2 行：`[Parameter(Mandatory = $true)][string]$Scenario,`
- 第 14 行：`$pythonExe = (Get-Command python -ErrorAction Stop).Source`
