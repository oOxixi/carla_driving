...
上级模块：[模块说明](../modules/support-delivery.md) · 实现：[docker/entrypoints/controller.sh](../../../docker/entrypoints/controller.sh)
...
- 第 13 行：`if [[ -n "${CONTROLLER_COMMAND:-}" ]]; then`
...
### `docker/entrypoints/controller.sh`

来源 SHA256：`7bcc3b59f6f85c79234d47e6802bf1e0239f9ea59d3d47e615dafa82fc6ddcda`。
